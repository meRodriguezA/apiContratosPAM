...
from src.config import DEFAULT_TEMPLATE_FILENAME_CONTRATO

class TemplateInstallerContrato:
    def __init__(self, paths: AppPaths, logger: Logger = None):
        self.paths = paths
        self.logger = logger or Logger()

    def ensure_external_template(self) -> str:
        dst = os.path.join(self.paths.external_templates_dir, DEFAULT_TEMPLATE_FILENAME_CONTRATO)
